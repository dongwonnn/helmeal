...
import { MenuInfoContainer, MainImageContainer, MenuDetail, MenuNutrient, DoughnutContainer, Gap, MenuProtein, MenuCalorie, MenuIntegrity } from './styles'
...
const MenuInfo:FC<MenuInfopRrops> = ({ totalMealInfo, totalSnackInfo, currentMeal}) => {
